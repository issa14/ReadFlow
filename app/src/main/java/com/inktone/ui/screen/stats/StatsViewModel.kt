package com.inktone.ui.screen.stats

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.inktone.data.database.ReadingSessionDao
import com.inktone.domain.usecase.StreakCalculator
import com.inktone.domain.usecase.StreakResult
...
class StatsViewModel @Inject constructor(
    ...
    private suspend fun computeStats(sessions: List<com.inktone.data.database.entity.ReadingSessionEntity>) {
